    ...
    case msg of
        ...
        GotRandomNumbers numbers ->
            let
                ...
                newGameState =
                    case List.length (Debug.log "INFL" <| Network.influencees model.recruiter newGraph2) == Graph.size newGraph2 - 1 of
                        True ->
                            GameOver
            ...
            case msg_ of
                CellGrid.MouseClick ( i, j ) ( x, y ) ->
                    let
                        ...
                        message =
                            "Grid, node = " ++ String.fromInt index ++ ", (i,j) = (" ++ String.fromInt i ++ ", " ++ String.fromInt j ++ ")"
                    in
